...
namespace ryanmurraynwo\entrydropdown\fields;

use ryanmurraynwo\entrydropdown\EntryDropdown;
use ryanmurraynwo\entrydropdown\assetbundles\entrydropdownfield\EntryDropdownFieldAsset;
 ...
 * @since     1.0.0
 */
class EntryDropdownField extends Field
{
    // Public Properties
    // =========================================================================
    ...
    {
        return Craft::t('entry-dropdown', 'EntryDropdownField');
    }
    ...
    public function getSettingsHtml()
    {
        ...
        return Craft::$app->getView()->renderTemplate(
            'entry-dropdown/_components/fields/EntryDropdown_settings',
            [
                'field' => $this,
            ]
        );
    ...
    public function getInputHtml($value, ElementInterface $element = null): string
    {
        ...
        Craft::$app->getView()->registerAssetBundle(EntryDropdownFieldAsset::class);
        ...
        Craft::$app->getView()->registerJs("$('#{$namespacedId}-field').EntryDropdownEntryDropdown(" . $jsonVars . ");");

        // Render the input template
        return Craft::$app->getView()->renderTemplate(
            'entry-dropdown/_components/fields/EntryDropdown_input',
            [
                'name' => $this->handle,
                'value' => $value,
                'field' => $this,
